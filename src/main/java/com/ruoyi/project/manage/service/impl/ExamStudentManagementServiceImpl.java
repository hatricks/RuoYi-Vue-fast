...
import com.ruoyi.common.utils.MailExamUtils;
...
public class ExamStudentManagementServiceImpl implements IExamStudentManagementService {
    ...
    @Override
    public int updateUserStatus(ExamStudentManagement examStudentManagement) {
        int result = examStudentManagementMapper.updateUserStatus(examStudentManagement.getId());
        MailExamUtils.sendMessage(examStudentManagement.getEmail(), examStudentManagement.getExamName(), DateUtil.date(examStudentManagement.getExamDate()).toString());
        return result;
    }
